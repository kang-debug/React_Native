    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            <View style={[styles.container, {flex:2}]}>
                <TextInput style={styles.input} placeholder={'ID'} onChangeText={newId => setUserId(newId)}/>
                <TextInput style={styles.input} placeholder={'Password'} onChangeText={newPw => setUserPw(newPw) } 
                secureTextEntry={true}/>
                <TextInput style={styles.input} placeholder={'Repeat Password'} onChangeText={newPw2 => setUserPw2(newPw2)}
                secureTextEntry={true}/>
            </View>
